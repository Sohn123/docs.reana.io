...
## Webhook renewal in REANA 0.95

As of REANA 0.95 release series, GitLab webhook authorization expires and
must be renewed from your REANA profile. The expiry and renewal controls
described below apply to 0.95 deployments; earlier releases do not provide
this renewal flow.

Your profile shows the webhook authorization expiry and
